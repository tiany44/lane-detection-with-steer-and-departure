...
class LaneDetection:
    ...
    def readVideo(self):
        ...
        inpImage = cv2.VideoCapture(os.path.join(self.CWD_PATH, 'drive.mp4'))
    ...
    def processImage(self, inpImage):
        ...
        return self.readVideo(), hls_result, gray, thresh, blur, canny
    ...
    def addText(self, img, radius, direction, deviation, devDirection, steering_angle):
        ...
        cv2.putText(img, 'Steering Angle: ' + str(steering_angle), (50, 250), font, 0.8, (0, 100, 200), 2, cv2.LINE_AA)
